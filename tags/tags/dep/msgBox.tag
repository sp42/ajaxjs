...
<fieldset class="warningMsgBox">
	...
	<div align="center">
		...
		style="font-size:14px;" class="middle btn exit-dep hide">关&nbsp;&nbsp;闭</a>
	</div>
	<div class="btn exit close topRight" onclick="document.querySelector('.warningMsgBox').style.display= 'none';">×</div>
</fieldset>
...
%>
	...
	<script>
		msgBox.fadeFullScreen_Panel = function(showBtn, panel_el){
			...
			//debugger;
			var closeBtn = this.panel_el.querySelector('.x-btn.close');
			if (closeBtn){
