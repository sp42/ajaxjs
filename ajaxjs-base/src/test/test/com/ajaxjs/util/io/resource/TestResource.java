package test.com.ajaxjs.util.io.resource;
...
public class TestResource {
	...
	public void testScanClass() {
		Set<Class<Object>> classes = ScanClass.scanClass("test.com.ajaxjs.io");
	...
	public void testScanAnything() {
		Set<Object> anything = new ScanAnything().scan("test.com.ajaxjs.io");
		// 有内部类
