...
public class ReflectUtil {
	 ...
	 */
	public static Object execMethod(Object obj, String methodName, Object... params)
	...
	public static Object execStaticMethod(Class<?> c, String methodName, Object... params)
			throws NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		Object result = null;
		Class<?>[] parameterTypes = new Class<?>[] {};
	...
	public static <T extends Object> T newInstance(Class<T> clazz, Object... initargs) throws InstantiationException,
	 ...
	 */
	public static <T extends Object> Constructor<T> getConstructor(Class<T> clazz, Class<?>[] parameterTypes)
			throws NoSuchMethodException {
		...
		for (int i = 1; i < parameterMatchingCountList.size(); i++) {
			if (parameterMatchingCountList.get(maxMatchingCountIndex).intValue() < parameterMatchingCountList.get(i)
					.intValue()) {
	 ...
	 * @return Constructor<T>
	 */
	public static <T extends Object> Method getMethod(Class<T> clazz, String methodName, Class<?>[] parameterTypes)
			throws NoSuchMethodException {
	...
	public static Object getFieldValueWithMethod(Object obj, String fieldName) throws IntrospectionException,
	...
	public static void setFieldValueWithMethod(Object obj, String fieldName, Object fieldValue)
			throws IntrospectionException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException,
