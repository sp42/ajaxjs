...
%>
	...
	<%-- 				<a href="#"> <img src="${commonAsset}/images/gs.png" height="40" /></a> 
					...
					<a href="#"> <img src="${STATIC_ASSET_SERVER}/images/360logo.gif" width="90" style="margin-top: 15px;" /></a> 
				</div>
				...
				<script src="${STATIC_ASSET_SERVER}/lib/Chinese.js"></script>
				<br /> 
...
<c:if test="${EASY_CONFIG.website_livereComment_enable}">
			<!-- 来必力City版安装代码 -->
			<div id="lv-container" data-id="city" data-uid="${EASY_CONFIG.website_livereComment_uid}" style="margin:10px;">
				<script>
				   (function(d, s) {
...
<c:if test="${type == 'comment' && EASY_CONFIG.website_livereComment_enable}">
			<!-- 来必力City版安装代码 -->
			<div id="lv-container" data-id="city" data-uid="${EASY_CONFIG.website_livereComment_uid}" style="margin:10px;">
				<script>
				   (function(d, s) {
...
<c:if test="${type == 'baidu_tongji' && EASY_CONFIG.website_baidu_tongji_enable}">
	<!-- 百度网站统计 -->
	<script>
		var _hmt = _hmt || [];
		(function() {
		  var hm = document.createElement("script");
		  hm.src = "https://hm.baidu.com/hm.js?${EASY_CONFIG.website_baidu_tongji_scriptId}";
		  var s = document.getElementsByTagName("script")[0]; 
		  s.parentNode.insertBefore(hm, s);
		})();
	</script>
...
<c:if test="${type == 'share_btns' && EASY_CONFIG.website_share_btns_enable}">
	<!-- http://www.bshare.cn 分享按钮 -->
