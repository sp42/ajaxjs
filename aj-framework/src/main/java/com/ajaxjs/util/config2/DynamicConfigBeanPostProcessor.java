...
//
///**
// * PostProcessor for any bean which has annotation @DynamicConfig on its
// * Class/Field, The processor will maintain field accessor for @Value fields,
// * listen ConfigurationChangedEvent, If any event arrives, it will retrieve diff
// * results of changed properties, evaluate SpEL and set field values.
// *
// * @author Code2Life
// */
//public class DynamicConfigBeanPostProcessor implements BeanPostProcessor {
//	private static final LogHelper LOGGER = LogHelper.getLog(DynamicConfigBeanPostProcessor.class);
//
...
//
//	/**
//	 * Process all beans contains @DynamicConfig annotation, collect metadata for
//	 * continuous field value binding
//	 *
...
//		}
//
//		if (propKeyList.size() > 0)
//			LOGGER.info("dynamic config annotation found on class: {}, field: {}, prop: {}", clazz.getName(), field.getName(), String.join(",", propKeyList));
//	}
//}