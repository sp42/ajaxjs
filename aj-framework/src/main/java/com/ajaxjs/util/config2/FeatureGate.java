...
/**
 * A util bean for simple feature gate implementation. Step1:
 * {@literal @}Value("#{{@literal @}featureGate.convert('${dynamic-feature-conf}')}")
 * private Set{@literal <}String{@literal >} someBetaFeatureConfig; Step2:
 * boolean featureEnabled =
 * FeatureGate.isFeatureEnabled(dynamicConfigBean.someBetaFeatureConfig(),
 * "someId")
 *
 * @author Code2Life
 **/
...
public class FeatureGate {
	...
	/**
	 * Transform a comma separated string into a set, indicate which entities enable
	 * that feature eg: someFeatureBetaList: userGroup1, userGroup2, ...
	 *
	 ...
	 *
	 * @param featureConfigValues the Set contains all entities which enable certain
	 *                            feature
	...
	/**
	 * Judge if some feature is enabled in configuration files eg:
	 * my.feature.enabled=true / True / TRUE
	 *
