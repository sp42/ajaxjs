				...
				<div class="main-panel"> 
					...
					<table>
						<thead>
							...
							<th>#</th><th>流程名称</th><th>实例启动时间</th><th>实例结束时间</th><th>期望完成时间</th><th>实例创建人</th><th>操作</th></tr>
						</thead>
						<tr v-show="showAddNew" is="aj-grid-inline-edit-row-create" :columns="[]"></tr>
				...
				methods: {
					gridCols() {
						return ['name', 
							...
							data => new Date(data.endDate).format("yyyy-MM-dd hh:mm"),
							data => data.extractData ? data.extractData.creatorUserName : data.creator];
					}
				}
			}); 
