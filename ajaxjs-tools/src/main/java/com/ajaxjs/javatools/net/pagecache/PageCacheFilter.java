...
import com.ajaxjs.javatools.net.pagecache.cache.CacheStore;
import com.ajaxjs.javatools.net.pagecache.config.PageCacheGlobalConfig;
import com.ajaxjs.javatools.net.pagecache.config.UrlKeyCreator;
...
public class PageCacheFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
		if (request instanceof HttpServletRequest && response instanceof HttpServletResponse) {
			...
			if ("GET".equalsIgnoreCase(method) || "POST".equalsIgnoreCase(method)) {
				...
				if (urlPattern != null) {
					String urlKey = UrlKeyCreator.getUrlKey(requestUri, urlPattern, httpRequest.getParameterMap()), pageContent = cacheStore.get(urlKey);
	...
	public void init(FilterConfig arg0) throws ServletException {
		String cacheStoreName = arg0.getInitParameter("cacheStore"), cacheStoreParams = arg0.getInitParameter("cacheStoreParams");
	...
	private void initGrobleConfig(String urlPattern, String cacheExpireTime, String includeParams, String excludeParams) {
		String[] urlPatterns = urlPattern.split(","), cacheExpireTimes = cacheExpireTime.split(",");
