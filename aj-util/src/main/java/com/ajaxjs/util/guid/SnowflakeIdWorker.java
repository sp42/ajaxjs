...
public class SnowflakeIdWorker {
	...
	protected long timeGen() {
		// 优化点：高并发场景下System.currentTimeMillis()存在性能问题（System.currentTimeMillis()是native方法，即获取时间需要和操作系统进行交互（涉及到用户态与内核态的切换），优化引入SystemClock
	...
	public static String getId() {
		return new SnowflakeIdWorker(0L, 0L).generateNextId();
