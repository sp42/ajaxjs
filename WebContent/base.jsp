    ...
    <head>
        ...
        <style>
            ...
            fieldset div.box {
                ...
                background-image: linear-gradient(90deg, rgba(255, 255, 255, .1) 0, rgba(89, 195, 232, .9) 100%);
                height: 460px;
                width: 95%;
                color: white;
                padding: 3% 10% 4% 4%;
                ...
                <tr>
                    <Td align="center" valign="middle">
						...
						%>
                                    ...
                                    <p>这是一个平淡无奇的库，相信不会为绝大多数大神们带来一点惊喜——只是自己业余累积的一些代码库（“轮子”）， 希望通过简单的手段做一件事（没啥三方依赖），不过可能就是考虑的情况不是很足，方法不是最主流的，性能不是最优的。 此为纯 Java 项目，应可运行在 web、swing、android 环境中，当然主要还是面向 Web 开发。base 包含了相当多的工具类或静态方法，详见右边菜单栏。Maven: </p>
...
&lt;/dependency&gt;</pre>
                                    ...
                                    <p>
                                        <a href="https://gitee.com/sp42/ajaxjs-base">Git/SVN 源码</a> | <a href="https://framework.ajaxjs.com/framework/ajaxjs-base-doc/">JavaDoc</a> | <a href="http://ajaxjs.mydoc.io/">手册</a> |
                                        <a href="http://blog.csdn.net/zhangxin09">博客</a> | <a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=3877893a4ed3a5f0be01e809e7ac120e346102bd550deb6692239bb42de38e22">QQ
								群：315006</a> | <a href="mailto:support@ajaxjs.com">联系邮箱</a>
                                        <p>基于 Apache License Ver2.0 开源协议，免费使用、修改，引用请保留头注释。</p>
                                        <p>
                                            关联项目： <a href="index.jsp">AJAXJS-Web</a> | <a href="https://gitee.com/sp42/ajaxjs-cms">AJAXJS-CMS</a>
                                        </p>
						...
						%>
                                            ...
                                            <ul class="task-list">
                                                ...
                                                <li>collection，集合工具类，map 的工具方法，还有 map/list/JSON 的遍历器</li>
                                                <li>io，处理流 Stream 的包，使用了链式调用的风格。有文件读写、流工具类和简易图片处理器；</li>
                                                <li>reflect，反射工具包，进行反射操作封装；</li>
                                                <li>cryptography，加密解密包，AES/DES/RSA 对称、非对称加密解密；</li>
                                                <li>mock，测试用模拟对象；</li>
                                                <li>ioc，一个简易的 ioc 依赖注射实现；</li>
                                                <li>aop，一个基于 Java Proxy 简易的 aop 实现；</li>
                                            </ul>
                                            <p>
						...
						%>
                                                ...
                                                <p>围绕数据库而设的一些工具包，大体上分为两种模块，一种是简单的增删改查函数，基于 JDBC 浅浅的封装；另外一种是基于 ORM 思想的方案，类似于 MyBatis 方式。</p>
                                                <p>
                                                ...
                                                <p>数据业务层框架，提供泛型封装 Service/DAO/Model 提供快速增删改查服务，包含分页，查询条件，整合 JSR-349 Validator 后端验证。该模块包含以下子模块：</p>
                                                <ul class="task-list">
                                                ...
                                                <p>
                                                    特色是同时支持 Map 和 Bean 两种数据载体。<a href="http://ajaxjs.mydoc.io/?t=203095">&gt;&gt;详细用法参见手册</a>。
                                                </p>
                                                <%
							}
							if (show.equals("js")) {
						...
						<p>
						 ...
						 -->
                                                    ...
                                                    <ul class="task-list">
                                                        <li>http 可发送 GET/POST/PUT/DELETE 请求。远没有 Apache HttpClient 完善，但足以满足一般的请求；
                                                        </li>
						...
						%>
                                                        <h1>
                                                            <a id="版权声明-license" class="anchor" href="#%E7%89%88%E6%9D%83%E5%A3%B0%E6%98%8E-license"></a>版权声明 LICENSE
                                                        </h1>
 ...
 */
						...
						%>
                            ...
                            <ul class="section">
                                ...
                                <li><a href="?show=js">JSON/Net</a></li>
