...
<%-- 	<UI:adminHeader pageTitle="${uiName}管理" /> --%>
	...
	<table align="center" width="50%">
		...
		<tr>
			<td class="holder">
				...
				<br />
				<select class="ajaxjs-select" onchange="onSelectChange(this);" data-level="1" multiple="multiple"></select></p>
			</td>
		</tr>
		<tr>
			<td>
				...
				<br />
				<form style="margin:0;" class="ajaxjs-form createTopNode" action="create.do" method="post">
					<div class="label">
						新增${uiName}
					</div>
					<input type="text" name="name" style="width:20%;" />
					<button class="ajaxjs-btn"><img src="${pageContext.request.contextPath}/asset/common/images/icon/add.gif" /> 新建${uiName}</button>
				</form>
			
				
				<form style="margin:0;" class="ajaxjs-form modifly_Name" action="." method="put">
					<label style="width:300px;">
						<div class="label">
							修改${uiName}名称
						</div>
						<input type="text" class="modiflyName" name="name" style="width:20%;" />
						<input type="hidden" class="modiflyName_level" />
						<input type="hidden" class="noPassServerParentId" />
						
						<button class="ajaxjs-btn"><img src="${pageContext.request.contextPath}/asset/common/images/icon/update.gif" /> 更新名称</button>
						<button onclick="sendDelete(this);return false;" class="ajaxjs-btn"><img src="${pageContext.request.contextPath}/asset/common/images/icon/delete.gif" /> 删除${uiName}</button>
					</label>
				</form>
			</td>
		</tr>
	...
	<script>
		// 新增顶级${uiName}
		var createTopNode = new form(document.querySelector('.createTopNode'));
