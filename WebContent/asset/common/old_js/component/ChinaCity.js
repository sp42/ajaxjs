...
ChinaCity.data = [{
	...
	sub: [{
		...
		name: "东莞市",
		sub: [{name:"东坑镇"},{name:"桥头镇"},{name:"望牛墩镇"},{name:"茶山镇"},{name:"谢岗镇"},{name:"莞城区"},{name:"南城区"},{name:"樟木头镇"},{name:"大朗镇"},{name:"塘厦镇"},{name:"凤岗镇"},{name:"道滘镇"},{name:"沙田镇"},{name:"高埗镇"},{name:"石龙镇"},{name:"石排镇"},{name:"企石镇"},{name:"石碣镇"},{name:"洪梅镇"},{name:"麻涌镇"},{name:"寮步镇"},{name:"大岭山镇"},{name:"常平镇"},{name:"厚街镇"},{name:"万江区"},{name:"清溪镇"},{name:"横沥镇"},{name:"中堂镇"},{name:"松山湖"},{name:"长安镇"},{name:"黄江镇"},{name:"虎门镇"},{name:"东城区"}]
	}, {
		name: "中山市",
		sub: [{name:"火炬开发区"},{name:"沙溪镇"},{name:"五桂山镇"},{name:"阜沙镇"},{name:"东升镇"},{name:"板芙镇"},{name:"神湾镇"},{name:"港口镇"},{name:"大涌镇"},{name:"民众镇"},{name:"南朗镇"},{name:"小榄镇"},{name:"古镇"},{name:"坦洲镇"},{name:"黄圃镇"},{name:"横栏镇"},{name:"三角镇"},{name:"南头镇"},{name:"三乡镇"},{name:"东凤镇"},{name:"东区街道"},{name:"西区街道"},{name:"南区街道"},{name:"石岐区街道"},{name:"沙朗镇"}]
	}, {
		name: "潮州市",
		sub: [{
			name: "市辖区"
	...
	name : "香港", sub:[{name:"中西区"},{name:"东区"},{name:"九龙城区"},{name:"观塘区"},{name:"南区"},{name:"深水埗区"},{name:"湾仔区"},{name:"黄大仙区"},{name:"油尖旺区"},{name:"离岛区"},{name:"葵青区"},{name:"北区"},{name:"西贡区"},{name:"沙田区"},{name:"屯门区"},{name:"大埔区"},{name:"荃湾区"},{name:"元朗区"}]
}, {name : '澳门', sub:[{name:'澳门半岛'},{name:'路环岛'},{name:'氹仔岛'}]},{
	name : '台湾',
	sub:[{name:"台北"},{name:"高雄"},{name:"台中"},{name:"花莲"},{name:"基隆"},{name:"嘉义"},{name:"金门"},{name:"连江"},{name:"苗栗"},{name:"南投"},{name:"澎湖"},{name:"屏东"},{name:"台东"},{name:"台南"},{name:"桃园"},{name:"新竹"},{name:"宜兰"},{name:"云林"},{name:"彰化"}]
}];


JSON.Path = new (function(){
    var childrenToken = 'sub' || 'children';
    /**
     * iterator
     * @param {Array} arr
     * @param {Object} scope
    ...
    function array_Iterator(arr, scope, i, j){
        ...
        // do something...
        if(array_Iterator.Fn && array_Iterator.Fn.call(scope, elmemnt, arr, i, j) == false){
            return;
        }
        // do something-End
        
        var children = elmemnt[childrenToken];
        if (children && children.length){
            // -->y
            array_Iterator(children, elmemnt/*已经变了这个Scope*/, 0, j + 1);// var x = j + 1; // 每一次循环children都会对j产生变化
        };
        // -->x
    ...
    this.buildPath = function(){
        ...
        array_Iterator.Fn = function(e, arr, i, j){
            if(!this.fullPath)this.fullPath = ''; // 执行此步的时候为根目录
//          // 包含父路径的全称路径
            e.fullPath = this.fullPath + '/' + e.name;
//          // 缩进
            e.sj = j;
            this[e.name] = e;
        }
     ...
     * @return {Object}
     */
    this.buildIndex = function(arr, keyName, handler){
        var hash;
...
;(function() {
	...
	function onClk(e) {
		...
		if (this.levelCount != levelIndex) {
			var data = levelIndex == 0 ? ChinaData : JSON.Path.getNode("/" + this.selectData[levelIndex - 1]).sub;
			...
			for (var i = 0, j = sNodes.length; i < j; i++) {
				sNode = sNodes[i];
				if (sNode == span)
					sNode.classList.add('selected');// highlight it!
				else
