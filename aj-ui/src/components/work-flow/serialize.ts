...
import { Dot, DOT_TYPE } from './svg/dot';
...
export let serialize = {
    ...
    rect: {
        ...
        //     for (let i in comp.rawData) {
        //         value = comp.rawData[i].value;
