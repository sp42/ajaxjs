...
public class Task extends BaseModel implements Cloneable {
	...
	public Long[] getActorIds() {
		if (actorIds == null) {
			...
			if (map != null && map.get(TaskModel.KEY_ACTOR) != null) {
				String actorStr = (String) map.get(TaskModel.KEY_ACTOR);
				actorIds = WorkflowUtils.cast(actorStr.split(","));
			}
		}
	...
	public boolean isMajor() {
		return getTaskType() == TaskType.Major.ordinal();
	}
}
