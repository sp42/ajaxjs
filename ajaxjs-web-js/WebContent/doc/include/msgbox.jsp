...
aj.showOk('Hello World!', function(){ alert('点击了确定按钮');}); // 显示“确定”按钮，第二个参数为回调，可选
aj.showConfirm("Hello World!", function(){alert('点击了 yes 按钮')}); // 显示“是、否”的选择按钮，第二个参数为点击“是”时候的回调，可选</pre>

<p>所有回调函数执行之后都会关闭弹出的窗体。</p>

<p>演示：</p>
<button class="ajaxjs-btn" onclick="aj.showOk('Hello World!', function(){ alert('点击了确定按钮');});">回调测试</button>
<button class="ajaxjs-btn" onclick="aj.showConfirm('Hello World!', function(){alert('点击了 yes 按钮')});">选择按钮</button>
