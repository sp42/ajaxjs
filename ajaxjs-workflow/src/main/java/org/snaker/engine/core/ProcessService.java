...
public class ProcessService extends AccessService implements IProcessService, CacheManagerAware {
	public static final LogHelper LOGGER = LogHelper.getLog(ProcessService.class);
	...
	public Process getProcessById(String id) {
		...
		if (entity != null) {
			LOGGER.info("obtain process[id={0}] from cache.", id);
		...
		if (entity != null) {
			LOGGER.info("obtain process[id={}] from database.", id);
			cache(entity);
		}
