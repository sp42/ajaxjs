...
public class ConcurrentRuleSyncUtil {
		...
		try {
			...
			for (Future<List<String>> feture : fetures) {
				...
				try {
					...
					System.err.println("ConcurrentRuleSyncUtil thread activeAppList get error:" + e.getMessage());
				}
			...
			System.err.println("ConcurrentRuleSyncUtil activeAppList get error:" + e.getMessage());
		}
		return resList;
	}
	...
	public static String getResponseText(String queryUrl, String host, String ip) {
		...
		try {
			...
			if (responseCode > 400) {
				System.err.println("getResponseText for queryurl:" + queryUrl + " got responseCode :" + responseCode);
