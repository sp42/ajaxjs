...
public class ConfigListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent e) {
		...
		System.out.println("配置启动完毕" + Constant.ConsoleDiver);
	}
	...
	private static void initLoggerFileHandler(ServletContext cxt) {
		String loggerFile = cxt.getRealPath("/") + "META-INF" + Constant.file_pathSeparator + "logger" + Constant.file_pathSeparator + "log.txt";
