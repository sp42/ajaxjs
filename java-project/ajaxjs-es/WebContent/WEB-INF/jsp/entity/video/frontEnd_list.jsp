...
<tags:content isSecondLevel="true">
	<jsp:attribute name="body">
		...
		<ul class="filter">
			<li><a href="?">全部</a></li>
		<c:foreach var="current" items="${all_portals_video}">
	...
	<ul class="filter">
		<li><a href="?">全部</a></li>			
	<c:foreach var="current" items="${all_catalogs_video}">
		<li>
		...
		<ul class="list">
			<c:foreach var="current" items="${PageResult.rows}">
				<li>
					...
					<div class="col_meta">
						${all_portals_video_map[current.portalId]['name']} | ${all_catalogs_video_map[current.catalog]['name']} | 
