...
public class TestExpire extends TestSnakerBase {
	...
	@Test
	public void test() {
		System.out.println(DateHelper.parseTime(new Date(2014, 4, 6, 16, 41)));
		Map<String, Object> args = new HashMap<String, Object>();
		args.put("task1.operator", new String[]{"1"});
		args.put("task1.expireTime", new Date(2014, 4, 15, 9, 0));
		args.put("task1.reminderTime", new Date(2014, 4, 15, 8, 57));
