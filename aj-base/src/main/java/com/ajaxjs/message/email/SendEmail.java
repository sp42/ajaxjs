...
public class SendEmail {
	 ...
	 * @return
	 */
	public boolean send(String to, String subject, String cotent) {
		Mail mail = new Mail();
	...
	public static boolean parse(String express, Map<String, Object> map) {
		...
		cxt.setPropertyAccessors(Arrays.asList(new MapAccessor()));
		...
		return expr.getValue(map, Boolean.class);
