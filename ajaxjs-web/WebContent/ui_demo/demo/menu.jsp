    ...
    <body>
		...
		<div class="p">
			...
			<ul>
				...
				<li>相关文章<a href="http://blog.csdn.net/zhangxin09/article/details/17659883">《利用 hover 伪类创建纯 CSS 收缩面板 》</a></li>
				<li> 如何解决点击之后马上隐藏面板？由于 js（单击事件） 没有控制 CSS 的 :hover 伪类的方法，故所以必须使用以下技巧：<br />
				<pre class="prettyprint" style="height:100px;">
