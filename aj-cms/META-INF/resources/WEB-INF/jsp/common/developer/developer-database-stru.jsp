<%@ page language="java" contentType="text/html; charset=UTF-8"
	import="java.util.*, java.sql.*,com.ajaxjs.cms.common.developer.DataBaseStruController,com.ajaxjs.framework.filter.DataBaseFilter,com.ajaxjs.sql.JdbcConnection"
	pageEncoding="UTF-8"%>
