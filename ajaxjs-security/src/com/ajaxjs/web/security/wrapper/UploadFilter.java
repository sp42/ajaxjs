...
import com.ajaxjs.web.security.filter.SecurityFilter;
 ...
 *
 */
public class UploadFilter extends HttpServletRequestWrapper implements SecurityFilter {

	public UploadFilter(HttpServletRequest request) {
		super(request);
	}
