...
<html>
	...
	<body>
		<div class="vue">
			...
			<!-- 搜索、分类下拉 -->
			<aj-admin-filter-panel :catelog-id="${domainCatalog_Id}" 
				:selected-catelog-id="${empty param.catelogId ? 'null' : param.catelogId}">
				
				<!-- 选择商家 -->
				商家过滤器：<select class="ajaxjs-select" onchange="location.assign('?filterField=sellerId&filterValue=' + this.selectedOptions[0].value);">
