	...
	<div>
		...
		<div class="aj-simple-tab-horizontal tab" style="padding: 1% 5%;">
				<ul>
					...
					<li :class="{'selected': 1 === selected}" @click="selected = 1">数据库连接管理</li>
					<li :class="{'selected': 2 === selected}" @click="selected = 2">代码生成器</li>
					<li :class="{'selected': 3 === selected}" @click="selected = 3">后台日志浏览</li>
				</ul>
			<div class="content">
	...
	<tbody>
		...
		<div>
			Notes:数据库 url 注意相关字符串要转义，如：&amp;
				...
				<div :class="{'selected': 2 === selected, codeGen:true}">
					<!-- TAB 内容 -->
