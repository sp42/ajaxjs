...
import com.ajaxjs.user.role.service.UserRoleResourcesService;
 ...
 *
 */
@Path("/admin/user_admin/role_resources")
@Bean("UserRoleResourcesController")
public class UserRoleResourcesController extends CommonController<Map<String, Object>, Integer, UserRoleResourcesService> implements CommonEntryAdminController<Map<String, Object>, Integer> {
	@Resource("UserRoleResourcesService")
	private UserRoleResourcesService service;
	...
	public String list(@QueryParam("start") int start, @QueryParam("limit") int limit, ModelAndView model) throws ServiceException {
		...
		return jsp_perfix + "user-admin/resources";
	}
