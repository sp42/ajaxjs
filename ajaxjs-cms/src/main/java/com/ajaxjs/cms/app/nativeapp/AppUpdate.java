...
public class AppUpdate extends BaseModel {
	 ...
	 * 设置实体状态
	 * 
	 * @param status 实体状态，可自定义常量表示各种状态
	 */
	 ...
	 * 
	 * @param apkVersion 安卓版本号 YYYYMMDD+两位数字，例如2018090901
	 */
	 ...
	 * 
	 * @param iosVersion iOS版本号 YYYYMMDD+两位数字，例如2018090901
	 */
