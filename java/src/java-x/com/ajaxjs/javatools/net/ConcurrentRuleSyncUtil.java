...
public class ConcurrentRuleSyncUtil {  
    ...
    private static final Logger LOGGER = LogFactory.getLog(ConcurrentRuleSyncUtil.class);  
    ...
    public static List<String> activeAppList(List<String> strUrl, String queryString) {  
        if (!Util.isNotNull(strUrl)) return null;  
        ...
        try {  
            ...
            for(Future<List<String>> feture: fetures){  
                ...
                try {  
                    ...
                    LOGGER.warning("ConcurrentRuleSyncUtil thread activeAppList get error:" + e.getMessage());  
                } 
