...
public class UrlKeyCreator {
	public static String getUrlKey(String url, String urlPattern, Map<String, String[]> params) {
		...
		List<String> includeParams = PageCacheGlobalConfig.getUrlIncludeParams().get(urlPattern),
					 excludeParams = PageCacheGlobalConfig.getUrlExcludeParams().get(urlPattern);
