...
<body class="reg_login">
	...
	<div class="header"><img src="${ctx}/asset/images/logo.png" width="120px" />欢迎登录</div>
	
	<div class="bg">
		<img src="${ctx}/asset/images/user/login-background.jpg" />
		<div class="box">
			<h5>用户注册</h5>
			<form class="aj-form form-1" style="width:50%" action="../user/register" method="post" @submit="onSubmit">
				<dl>
					<label>
						<dt>用户 ID</dt>
						<dd>
							<input type="text" name="name" placeholder="请输入用户名/邮箱/手机号码" @blur="checkUserId($event)" />
