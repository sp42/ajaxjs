...
public class TFIDF {
     ...
     * @return path of file and its  corresponding "word-TF Value" pairs
     */
    public static HashMap<String, HashMap<String, Float>> tfForDir(String dirPath) {
        ...
        for (String file : filelist) {
            ...
            HashMap<String, Float> dict = TFIDF.getTF(content);
            allTF.put(file, dict);
        }
    ...
    public static HashMap<String, Float> idfForDir(String dirPath) {
        ...
        for (String filePath : fileList) {
            ...
            for (String word : wordSet) {
                if (wordPassageNum.get(word) == null) wordPassageNum.put(word, 1);
                else wordPassageNum.put(word, wordPassageNum.get(word) + 1);
            }
        }
     ...
     *
     * @param dirPath(String): path of the directory
     * @return path of file and its corresponding "word:TF-IDF Value" pairs
     */
    public static Map<String, HashMap<String, Float>> getDirTFIDF(String dirPath) {
        HashMap<String, HashMap<String, Float>> dirFilesTF = TFIDF.tfForDir(dirPath);
        HashMap<String, Float> dirFilesIDF = TFIDF.idfForDir(dirPath);

        Map<String, HashMap<String, Float>> dirFilesTFIDF = new HashMap<>();
     ...
     * @return path of file and its corresponding keywords
     */
    public static Map<String, List<String>> getKeywords(String dirPath) {
        ...
        Map<String, HashMap<String, Float>> dirTFIDF;
