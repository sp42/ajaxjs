...
public class Utils {
    ...
    static void writePng(BufferedImage img, String filepath) throws IOException {
     ...
     */
    static String toSvgString(QrCode qr, int border, String lightColor, String darkColor) {
        Objects.requireNonNull(qr);
