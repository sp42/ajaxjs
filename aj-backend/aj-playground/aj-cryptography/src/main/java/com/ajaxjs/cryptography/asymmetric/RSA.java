...
public class RSA extends Common {
    ...
    public static String sign(byte[] data, String privateKey) {
        try {
            ...
            return Utils.base64EncodeToString(signature.sign());
    ...
    public static boolean verify(byte[] data, String publicKey, String sign) {
        try {
            ...
            return signature.verify(Utils.decodeFromString(sign));
        } catch (NoSuchAlgorithmException | InvalidKeyException | SignatureException e) {
            e.printStackTrace();
            return false;
        }
    ...
    private static Key restoreKey(boolean isPublic, String key) {
        byte[] bytes = Utils.decodeFromString(key);
    ...
    private static byte[] action(boolean isEncrypt, boolean isPublic, byte[] data, String key) {
        ...
        return SymmetricCipherInfo.doCipher(KEY_RSA, mode, restoreKey(isPublic, key), null, data);
    }
