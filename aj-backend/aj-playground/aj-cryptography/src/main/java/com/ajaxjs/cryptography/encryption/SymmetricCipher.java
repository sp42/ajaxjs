...
public class SymmetricCipher {
    ...
    public static String AES_Encrypt(String str, String key) {
        ...
        assert bytes != null;
        return Utils.base64EncodeToString(bytes);
    }
    ...
    public static String AES_Decrypt(String str, String key) {
        byte[] b = SymmetricCipherInfo.doCipher(AES, Cipher.DECRYPT_MODE, key, Utils.decodeFromString(str));
    ...
    public static String DES_Encrypt(String str, String key) {
        return Utils.base64EncodeToString(Objects.requireNonNull(SymmetricCipherInfo.doCipher(DES, Cipher.ENCRYPT_MODE, key, str.getBytes(StandardCharsets.UTF_8))));
    ...
    public static String DES_Decrypt(String str, String key) {
        return Utils.byte2String(SymmetricCipherInfo.doCipher(DES, Cipher.DECRYPT_MODE, key, Utils.decodeFromString(str)));
    }
