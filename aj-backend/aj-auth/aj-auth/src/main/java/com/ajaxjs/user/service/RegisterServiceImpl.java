...
import com.ajaxjs.user.util.CheckStrength;
import com.ajaxjs.user.util.CheckStrength.LEVEL;
...
public class RegisterServiceImpl implements RegisterService {
	...
	public Boolean register(Map<String, Object> params) {
		...
		auth.setRegisterType(Login.LoginType.PASSWORD);
	...
	@Override
	public Boolean checkRepeat(@RequestParam String field, @RequestParam String value) {
		return isRepeat(field, value, SsoUtil.getTenantId());
	}
