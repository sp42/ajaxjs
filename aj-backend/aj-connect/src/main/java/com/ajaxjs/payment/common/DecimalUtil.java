package com.ajaxjs.payment.common;
...
public class DecimalUtil {
    ...
    public static double divide(double v1, double v2, int scale, int round_mode) {
        ...
        return new BigDecimal(Double.toString(v1)).divide(new BigDecimal(Double.toString(v2)), scale, round_mode).doubleValue();
    }
    ...
    public static String divide(String v1, String v2, int scale, int round_mode) {
        ...
        return new BigDecimal(v1).divide(new BigDecimal(v2), scale, round_mode).toString();
    }
    ...
    public static double round(double v, int scale, int round_mode) {
        ...
        return new BigDecimal(Double.toString(v)).setScale(scale, round_mode).doubleValue();
    }
    ...
    public static String round(String v, int scale, int round_mode) {
        ...
        return new BigDecimal(v).setScale(scale, round_mode).toString();
    }
}