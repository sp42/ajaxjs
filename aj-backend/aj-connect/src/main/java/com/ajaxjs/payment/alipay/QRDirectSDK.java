package com.ajaxjs.payment.alipay;//package com.ajaxjs.framework.shop.alipay;

import com.ajaxjs.payment.alipay.model.AlipayConfig;
import com.ajaxjs.payment.alipay.model.AlipayRequestData;
import com.ajaxjs.payment.alipay.model.AlipayResponseData;
...
//	}
	...
	public QRDirectSDK(AlipayConfig config) {
		super(config);
	}
//
