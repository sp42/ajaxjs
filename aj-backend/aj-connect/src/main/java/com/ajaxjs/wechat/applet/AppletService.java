 ...
 * 小程序登录
 *
 * @param code 登录时获取的 code，可通过 wx.login() 获取
...
public Code2SessionResult code2Session(String code) {
     ...
     * @param scene          场景值，最长为 32 个字符。使用 K/V 编码，扩展性比较好
     * @param page           小程序页面路径，例如 pages/index/index
     * @param width          二维码的宽度，单位 px，最小 280px，最大 1280px
     */
    public void qrCode(boolean isTrialVersion, Map<String, Object> scene, String page, int width) {
