...
//			throw new UnsupportedOperationException(" 未定义 SiteStru 类型的 SITE_STRU，该常量应在 Servlet 初始化时定义。");
	 ...
	 * @return
	 */
	private static String buildNavBar(SiteStru sitestru, HttpServletRequest request) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	private static String buildSubMenu(SiteStru sitestru, HttpServletRequest request) {
		String ctx = request.getContextPath();
		StringBuilder sb = new StringBuilder();
	 ...
	 * @return
	 */
	private static String buildSecondLevelMenu(SiteStru sitestru, HttpServletRequest request) {
		String ctx = request.getContextPath();
		StringBuilder sb = new StringBuilder();
	 ...
	 */
	@SuppressWarnings("unchecked")
	private static String buildBreadCrumb(SiteStru sitestru, HttpServletRequest request) {
