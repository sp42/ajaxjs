...
package com.ajaxjs.net.ftp.sun.net.ftp;

import com.ajaxjs.net.ftp.sun.misc.REException;
import com.ajaxjs.net.ftp.sun.misc.RegexpPool;
import com.ajaxjs.net.ftp.sun.net.TelnetInputStream;
import com.ajaxjs.net.ftp.sun.net.TelnetOutputStream;
import com.ajaxjs.net.ftp.sun.net.TransferProtocolClient;
...
public class FtpClient extends TransferProtocolClient {
    ...
    public static boolean matchNonProxyHosts(String host) {
        synchronized (FtpClient.class) {
            String rawList = AccessController.doPrivileged(new sun.security.action.GetPropertyAction("ftp.nonProxyHosts"));
