<%@ page pageEncoding="UTF-8" import="java.util.*, com.ajaxjs.data.CRUD"%>
...
<body>
	...
	<ul>
	<%
	    com.ajaxjs.framework.spring.filter.dbconnection.DataBaseConnection.initDb();
		List<Map<String, Object>> list = CRUD.list("SELECT * FROM aj_base.sys_tenant");
		com.ajaxjs.data.jdbc_helper.JdbcConn.closeDb();
	%>
