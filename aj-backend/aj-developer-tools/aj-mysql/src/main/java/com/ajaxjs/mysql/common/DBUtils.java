...
public class DBUtils {
	...
	// private static final String INSTANCE_INFO_SQL="select INST_NUMBER, INST_NAME
	...
	/**
	 * Test is we can connect to db with given user name and password. If
	 * testRWPermission is true, we will test if we can create/drop/insert/delete a
	 * test table (for metrics db).
	 *
	 * @param dbinfo
	 * @param username
	 * @param password
	 ...
	 * @return
	 */
	public static String testConnection(DBInstanceInfo dbinfo, String username, String password, boolean testRWPermission) {
	...
	public static String testConnection(DBInstanceInfo dbinfo, String username, String password) {
		String url = dbinfo.getConnectionString();
		Connection conn = null;
		Statement stmt = null;
		ResultSet rs = null;
