...
import com.ajaxjs.mysql.manager.UserReportManager;
...
public class ReportController extends AbstractController {
	...
	private ModelAndView download(Map<String, String> pathParams, HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		do {
			...
			File f = new File(dir, pathParams.get(Constants.URL_PATH_ALERT_TYPE) + "_" + pathParams.get(Constants.URL_PATH_DBGROUP) + "_"
					+ pathParams.get(Constants.URL_PATH_DBHOST) + "_" + origTS + ".txt");
			if (!f.exists())
				break;
