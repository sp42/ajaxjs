...
public class AlertsController extends MyPerfBaseController {
    ...
    protected ModelAndView handleRequestImpl(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        if ("get_settings".equalsIgnoreCase(cmd)) return handleRetrieveSettings(req, resp);
        else if ("update_settings".equalsIgnoreCase(cmd)) return handleUpdateSettings(req, resp);
        ...
        else if ("get_top".equalsIgnoreCase(cmd)) return this.handleRetrieveNewAlerts(req, resp);
        ...
        HashSet<String> filteredGroups = new HashSet<>();
        ...
        // starting and ending dates, and their defaults. All values are in UTC, assume
        ...
        if (status == Constants.STATUS_BAD) return this.respondFailure(message, req);
    ...
    private ModelAndView handleRetrieveNewAlerts(HttpServletRequest req, HttpServletResponse resp) {
    ...
    private ModelAndView handleRetrieveSettings(HttpServletRequest req, HttpServletResponse resp) {
        ModelAndView mv = new ModelAndView(this.jsonView);
        ...
        if (group == null || group.isEmpty() || "all".equals(group)) updatable = false;
        else {
            AppUser appUser = AppUser.class.cast(req.getSession().getAttribute(AppUser.SESSION_ATTRIBUTE));
            if (!appUser.isAdminUser()) updatable = false;
        }
    ...
    private ModelAndView handleUpdateSettings(HttpServletRequest req, HttpServletResponse resp) {
        String message = null;
        int status = 0;
        AppUser appUser = AppUser.class.cast(req.getSession().getAttribute(AppUser.SESSION_ATTRIBUTE));
        String group = req.getParameter("group");
    ...
    private ModelAndView enableMetrics(HttpServletRequest req, HttpServletResponse resp) {
        String message = null;
        AppUser appUser = AppUser.class.cast(req.getSession().getAttribute(AppUser.SESSION_ATTRIBUTE));
        String group = req.getParameter("group");
        String host = req.getParameter("host");
        ...
        do {
            ...
            try {
                if (this.getFrameworkContext().getMetricDb().enableMetrics(group, host, "metrics_enabled_yes".equalsIgnoreCase(cmd), appUser.getName(), true)) {
    ...
    private ModelAndView enableAlerts(HttpServletRequest req, HttpServletResponse resp) {
        String message = null;
        AppUser appUser = AppUser.class.cast(req.getSession().getAttribute(AppUser.SESSION_ATTRIBUTE));
        String group = req.getParameter("group");
        String host = req.getParameter("host");
        ...
        do {
            ...
            try {
                if (this.getFrameworkContext().getMetricDb().enableAlerts(group, host, "alerts_enabled_yes".equalsIgnoreCase(cmd), appUser.getName(), true)) {
    ...
    private ModelAndView enableSNMP(HttpServletRequest req, HttpServletResponse resp) {
        String message = null;
        AppUser appUser = AppUser.class.cast(req.getSession().getAttribute(AppUser.SESSION_ATTRIBUTE));
        String group = req.getParameter("group");
        String host = req.getParameter("host");
        ...
        do {
            ...
            try {
                if (this.getFrameworkContext().getMetricDb().enableSnmp(group, host, "snmp_enabled_yes".equalsIgnoreCase(cmd), appUser.getName(), true)) {
