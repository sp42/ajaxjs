...
public class MetricsBuffer {
    ...
    public java.nio.ByteBuffer recordOneRowBymetricsName2(java.sql.ResultSet rs, int snap_id, long timestamp, int sql_time)
        ...
        int pos = 0;
        buf2.putInt(pos, dbid);
        pos += 4;
        buf2.putInt(pos, snap_id);
        pos += 4;
        buf2.putLong(pos, timestamp);
        pos += 8;
    ...
    public java.nio.ByteBuffer recordOneRowByMetricsMap(Map<String, String> rs, int snap_id, long timestamp, int sql_time) {
