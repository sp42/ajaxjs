...
public class MetricsRetentionTask implements Runnable {
	 ...
	 * @param dbidToPurge   use to start a one time job to purge data for a specific
	 *                      db, set to -1 otherwise
	 */
	public MetricsRetentionTask(MyPerfContext context, int renentionDays, int[] dbidToPurge) {
	...
	/**
	 * 
	 * @param lastPurgeDate The last date the report will be purged, in YYYYMMDD
	 *                      format
	 */
