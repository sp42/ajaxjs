...
public class ConnectionFactory {
	/**
	 * The purpose is to create JDBC connection to DBInstanceInfo db, using
	 * credential from cred. Using ConnectionFactory so that we can later cover
	 * multiple types of database.
	 *
	 * @param db
	 * @param cred
	 * @param context
	 ...
	 */
	public static Connection connect(DBInstanceInfo db, DBCredential cred, MyPerfContext context) throws java.sql.SQLException {
	...
	public static Connection connect(DBInstanceInfo db, String username, String password, MyPerfContext context) throws java.sql.SQLException {
