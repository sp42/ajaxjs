...
public class DerbyMetricsDb extends MetricsDbBase implements java.io.Serializable, Runnable {
    ...
    protected String buildMetricCodeDDL() {
        return "CREATE TABLE METRIC_CODE (" +
                "CODE_ID INT GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1), NAME VARCHAR(256))";
    ...
    protected String buildAlertDDL() {
        return "CREATE TABLE ALERT (" +
                "DBID INT, TS BIGINT, END_TS BIGINT DEFAULT 0, ALERT_TYPE VARCHAR(30), ALERT_REASON VARCHAR(128), PRIMARY KEY(DBID, TS))";
