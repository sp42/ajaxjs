...
public class TableMetaProcessor implements CustomQueryProcessor {
	...
	private final static String[] TBL_QUERIES = new String[] { "mysql_meta_table_constraints", "mysql_meta_table_triggers", "mysql_meta_table_create",
			"mysql_meta_table_indexes", "mysql_meta_innodb_index_stats", "mysql_meta_innodb_table_stats", "mysql_meta_table_stats",
			"mysql_meta_table_columns" };
	...
	public void queryMultiple(MyPerfContext context, DBInstanceInfo dbinfo, String appUser, DBConnectionWrapper connWrapper, QueryParameters qps,
			Map<String, ResultList> rListMap) throws java.sql.SQLException {
