...
public class CredController extends MyPerfBaseController {
	...
	@Override
	protected ModelAndView handleRequestImpl(HttpServletRequest request, HttpServletResponse resp) throws Exception {
		...
		if (dbGroupName == null || dbGroupName.isEmpty() || this.getFrameworkContext().getDbInfoManager().findGroup(dbGroupName) == null)
