...
public class MiniAppPay implements PayConstant {
	...
	public static Map<String, String> unifiedOrder(OrderInfo order, PerpayInfo perpayInfo) {
		...
		data.put("sign", WxUtil.generateSignature(data, PaySignatures.getMchSecretId()));

		return data;
	}

	@Deprecated
	public static Map<String, String> unifiedOrderOld(OrderInfo order, PerpayInfo perpayInfo) {
		LOGGER.info("微信统一下单请求交易开始");
		Map<String, String> data = new HashMap<>();
	...
	public static Map<String, String> getPayParam(String perpayId, String nonceStr) {
		...
		String paySign = WxUtil.generateSignature(map, PaySignatures.getMchSecretId());
